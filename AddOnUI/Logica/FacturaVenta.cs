...
namespace AddOnUI.Logica
{
    public class FacturaVenta
    {
        ...
        public static void AnularVenta(SAPbouiCOM.Form oForm)
        {
            try
            {
                ...
                if (iValor == 1)
                {
                    ...
                    Globals.Query = "SELECT \"DocEntry\" FROM OINV WHERE \"DocNum\"  ='" + oDocNum.Value.ToString() + "' ";
                    ...
                    //anular
                    SAPbobsCOM.Documents oDocSAP = (SAPbobsCOM.Documents)Globals.oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oInvoices);
